package com.example.dearu.global.security.jwt.provider;
...
import com.example.dearu.global.security.CustomUserDetails;
import com.example.dearu.global.security.jwt.config.JwtProperties;
...
public class JwtProvider {
    ...
    private Jws<Claims> getClaims(String token) {
        try {
            ...
            throw new CustomException(JwrError.EXPIRED_JWT_TOKEN);
        } catch (UnsupportedJwtException e) {
            throw new CustomException(JwrError.UNSUPPORTED_JWT_TOKEN);
        } catch (MalformedJwtException e) {
            throw new CustomException(JwrError.MALFORMED_JWT_TOKEN);
        } catch (IllegalArgumentException e) {
            throw new CustomException(JwrError.INVALID_JWT_TOKEN);
        }
    }
